...
# 1. Формируем задачу для Cron: 4 раза в день (каждые 6 часов)
# "0 */6 * * *" означает: в начале часа, каждые 6 часов (0, 6, 12, 18)
CRON_SAVE="0 */6 * * * /bin/bash $SCRIPT_PATH_SAVE >> $LOG_SAVE 2>&1"
